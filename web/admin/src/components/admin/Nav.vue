    ...
    <a-layout-sider breakpoint="lg" v-model="collapsed">
        ...
        <a-menu theme="dark" mode="inline" @click="goToPage">
            ...
            <a-sub-menu>
                ...
                <a-menu-item key="addarticle"> <a-icon type="form"></a-icon><span>写文章</span> </a-menu-item>
                <a-menu-item key="articlelist"> <a-icon type="snippets"></a-icon><span>文章列表</span> </a-menu-item>
            </a-sub-menu>
            <a-menu-item key="categorylist"> <a-icon type="book"></a-icon><span>分类列表</span> </a-menu-item>
